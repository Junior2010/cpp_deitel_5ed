...
// Define a classe GradeBook que contém um mebro de dados courseName
// e funçoes-membro para configurar e obter seu valor;
...
int main()
{
    ...
    cout << "Initial cour name is: " << myGradeBook.getCourseName()
        << endl;

    // solicita, inser e configura o nome do curso
